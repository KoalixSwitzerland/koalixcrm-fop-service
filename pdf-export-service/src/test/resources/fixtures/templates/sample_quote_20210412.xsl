            ...
            <fo:page-sequence master-reference="simple">
                            ...
                            <fo:table-row height="2cm" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="0.5pt">
                                ...
                                <fo:table-cell padding-bottom="3pt" >
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left"
                                              margin-top="0.15cm">Acme Technik AG</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left" >Hubstrasse 24</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left" >CH-9500 Wil</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left" >www.acme.example</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left" >aaron.riedener@acme.example</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left" >+41 79 291 07 24</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
                    </fo:table>
                ...
                <fo:flow flow-name="xsl-region-body">
                        ...
                        <fo:table-body font-size="7pt"
                            ...
                            <fo:table-row >
                                <fo:table-cell>
                                    ...
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">Offertennummer</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                ...
                                <fo:table-cell>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">713031600_IoT_Humidity_Sensor</fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">713031600_Appendix_<xsl:value-of select="commercial_document/@id"/></fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
                                    <fo:block font-size="7pt"
                                    ...
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">
                                        <xsl:value-of select="substring(commercial_document/extra/valid_until, 9, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(commercial_document/extra/valid_until, 6, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(commercial_document/extra/valid_until, 1, 4)"/></fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
                                    <fo:block font-size="7pt"
                    ...
                    <fo:block font-size="12pt"
                              ...
                              margin-top="1cm"
                              margin-bottom="0.5cm">
                        Offerte - <xsl:value-of select="commercial_document/description"/>
                    </fo:block>
                    <xsl:for-each select="commercial_document/text_paragraphs/text_paragraph">
                        <xsl:choose>
