  ...
  <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:static-content flow-name="xsl-region-before" >
	    ...
	    <fo:table-cell padding-bottom="3pt" >
              <fo:block font-size="7pt"
                        font-family="BitstreamVeraSans"
                        text-align="left"
	                margin-top="0.15cm">koalix Riedener</fo:block>
              <fo:block font-size="7pt"
                        font-family="BitstreamVeraSans"
                        text-align="left" >Grüenaustrasse 2</fo:block>
              <fo:block font-size="7pt"
                        font-family="BitstreamVeraSans"
                        text-align="left" >CH-9602 Bazenheid</fo:block>
	      <fo:block font-size="7pt"
                        font-family="BitstreamVeraSans"
                        text-align="left" >www.koalix.org</fo:block>
              <fo:block font-size="7pt"
                        font-family="BitstreamVeraSans"
                        text-align="left" >aaron.riedener@koalix.ch</fo:block>
              <fo:block font-size="7pt"
                        font-family="BitstreamVeraSans"
	...
	<fo:table-row >
          ...
          <fo:table-cell>
			...
			<fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left">CH14 0900 0000 8537 5800 4</fo:block>
			<fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left">MwSt Nummer</fo:block>
            <fo:block font-size="7pt"
