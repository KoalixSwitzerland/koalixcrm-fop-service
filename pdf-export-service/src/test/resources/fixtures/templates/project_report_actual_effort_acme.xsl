            ...
            <fo:page-sequence master-reference="simple">
                <fo:static-content flow-name="xsl-region-before">
                    <fo:table table-layout="fixed" width="100%">
                        <fo:table-column column-width="20.9cm"/>
                            ...
                            <fo:table-row height="2cm" border-bottom-color="black" border-bottom-style="solid"
                                ...
                                <fo:table-cell padding-bottom="3pt">
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left"
                                              margin-top="0.15cm">Acme Technik AG
                                    </fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">Hubstrasse 24
                                    </fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">CH-9500 Wil
                                    </fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">www.acme.example
                                    </fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">aaron.riedener@acme.example
                                    </fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">+41 71 291 07 24
                                    </fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
				...
				<xsl:variable name="work_in_task">False</xsl:variable>
                                <fo:table-row>
                                    <fo:table-cell border-color="black" border-style="solid" border-width="0.5pt"
                                                   padding="2.5pt">
						...
						<fo:list-item>
							...
							<fo:list-item-body start-indent="body-start()">
								<fo:block>
									For this task, no work has been performed during this reporting period
								</fo:block>
							</fo:list-item-body>
						</fo:list-item>
						</xsl:if>
